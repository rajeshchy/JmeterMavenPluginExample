...
$(document).ready(function() {
    ...
    createTable($("#statisticsTable"), {"supportsControllersDiscrimination": true, "overall": {"data": ["Total", 20, 0, 0.0, 255.0, 112, 434, 425.9, 433.6, 434.0, 29.197080291970803, 426.66086906934305, 3.364507299270073], "isController": false}, "titles": ["Label", "#Samples", "KO", "Error %", "Average", "Min", "Max", "90th pct", "95th pct", "99th pct", "Throughput", "Received", "Sent"], "items": [{"data": ["HTTP Request", 20, 0, 0.0, 255.0, 112, 434, 425.9, 433.6, 434.0, 29.197080291970803, 426.66086906934305, 3.364507299270073], "isController": false}]}, function(index, item){
        switch(index){
            // Errors pct
            case 3:
                item = item.toFixed(2) + '%';
